...
# # ///////////////WHAT DO WE CALL THE CODE SECTION BELOW?  WHAT IS IT DOING?
# # ///////////////AM I DEFINING A USER CLASS?
class User:
    # CD ! Class Attribute
    population_nero = 0
...
#  [keyword] [term -method or function_name or both] (self): dtf colon
    def gimme_the_411(self):
        ...
        print(self.first_name, self.last_name, self.age, self.account.int_rate, self.account.balance)
